...
comprar:- computadora(Marca, Modelo, Tipo, Uso, Precio, Pantalla, Procesador, Tarjeta_video, RAM, SO, HDD, USB2_0, USB3_0, NombreImg),
	...
	atom_concat('C:/Users/Julian/Downloads/SistemaExperto-master/SistemaExperto-master/sistemaexperto_imagenes/', NombreImg, RutaModelo),
...
%Laptop
computadora('Apple', 	'MacBook Pro',		'Laptop', 'Disenio', 	'3,200,000',	'13"',	'Intel Core i5', 	'Intel Iris Graphics 6100',	   '16GB', 	'OS X', 		'128GB (SSD)', 	'0', 	'2', 'macbookpro')			:- 	macbookpro, !.
computadora('HP', 		'Elitebook 840', 	'Laptop', 'Disenio', 	'3,100,000',	'11.5"','Intel Core i5',	'Intel HD Graphics 5500', 	   '16GB', 	'Windows 8.1', 	'1TB (HDD)', 	'2', 	'1', 'hp_elitebook')		:- 	hp_elitebook, !.
computadora('Lenovo',   'Y50-70', 			'Laptop', 'Gamer',		'1,800,000',	'12"',	'Intel Core i7', 	'NVIDIA GeForce GTX 860M', 	   '8GB',	'Windows 8.1',	'1TB (HDD)', 	'2', 	'1', 'lenovo_y50_70')		:- 	lenovo_y50_70, !.                    
computadora('Dell',		'Alienware 15 r3',	'Laptop', 'Gamer',		'3,300,000',	'15"',	'Intel Core i7', 	'NVIDIA GeForce GTX 970M', 	   '8GB',	'Windows 10',	'1TB (HDD)', 	'0', 	'3', 'dell_alienware_15_r2'):- 	dell_alienware_15_r2, !.
computadora('Toshiba',  'L55-b5179sm', 		'Laptop', 'Disenio', 	'1,800,920',	'12"', 	'Intel Core i7', 	'Intel HD Graphics 5500', 	   '8GB', 	'Windows 8.1', 	'1TB (HDD)', 	'2',	'1', 'toshiba_l55')			:- 	toshiba_l55, !.
computadora('HP', 		'14-af16la', 		'Laptop', 'Multimedia', '900,000',	'14"', 	'AMD A8', 			'AMD Radeon R5', 			   '6GB', 	'Windows 10', 	'1TB (HDD)', 	'2', 	'1', 'hp_14_af16la')		:- 	hp_14_af16la, !.
computadora('HP',	 	'Envy 14 u290la',	'Laptop', 'Multimedia', '1,200,000',	'14"',	'Intel Core i5', 	'Intel HD Graphics 5500', 	   '6GB',	'Windows 8.1',	'1TB (HDD)',	'1',	'2', 'hp_envy14')			:- 	hp_envy14, !.
computadora('GHIA', 	'Qcn3540', 			'Laptop', 'Oficina', 	'600,000',	'11.2"','Intel Pentium N3540','Intel HD Graphics', 	   	   '4GB', 	'Windows 8.1', 	'500GB (HDD)', 	'2', 	'1', 'ghia_qcn3540')		:- 	ghia_qcn3540, !.
computadora('Dell', 	'Inspiron 14-3442', 'Laptop', 'Multimedia', '800,000',	'14"', 	'Intel Core i3', 	'Intel HD Graphics 4400',  	   '4GB', 	'Windows 8.1', 	'1TB (HDD)', 	'2', 	'1', 'dell_inspiron_14')	:- 	dell_inspiron_14, !.
computadora('Asus',	 	'F455la', 			'Laptop', 'Multimedia', '1,900,000',	'15"', 	'Intel Core i5', 	'Intel HD Graphics 5500',  	   '4GB',	'Windows 8.1', 	'1TB (HDD)', 	'1', 	'2', 'asus_f455la')			:- 	asus_f455la, !.
computadora('Lenovo', 	'G40-30', 			'Laptop', 'Oficina', 	'700,000',	'11"', 	'Intel Celeron N2840','Intel HD Graphics 1100',    '4GB', 	'Windows 8.1', 	'500GB (HDD)', 	'2', 	'1', 'lenovo_g40_30')		:- 	lenovo_g40_30, !.
computadora('Acer',  	'TMB115',			'Laptop', 'Oficina', 	'480,000',	'11.6"','Intel Celeron N2940','Intel HD Graphics 1100',	   '4GB', 	'Linux Limpus',	'320GB (HDD)', 	'2', 	'1', 'acer_tmb115')			:- 	acer_tmb115, !.
%computadora('No se encontro un producto que cubra sus necesidades', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A').


%Escritorio
computadora('Dell',   	'Inspiron 3046',      	'Escritorio', 'Oficina',   	'750,000',  '21"',  			'Intel Core i3',        'Intel HD Graphics' ,      	'4GB',	'Windows 8.1', '750GB',  '4', '1', 'dell_inspiron_3046'):- dell_inspiron_3046, !.
computadora('GHIA',   	'Pentium dual g8040', 	'Escritorio', 'Oficina',   	'4700,000',  '29"',  			'Intel Celeron N2840',  'Intel HD Graphics 1100', 	'4GB', 	'Linux',       '500GB',  '4', '0', 'ghia_pentium_dual')	:- ghia_pentium_dual, !.
computadora('Dell',   	'Inspiron 2980',      	'Escritorio', 'Oficina',   	'630,000',  '23"',  			'Intel Celeron N3540',  'Intel HD Graphics 1100',  	'2GB', 	'Windows 8.1', '750GB',  '3', '1', 'dell_inspiron_2980'):- dell_inspiron_2980, !.
computadora('Lenovo', 	'Thinkcentre',       	'Escritorio', 'Multimedia', '1,200,000', '29"',  			'Intel Core i5' ,       'Intel HD Graphics 4400',   '4GB',  'Windows 8.1', '1TB',    '3', '3', 'lenovo_thinkcentre'):- lenovo_thinkcentre, !.                    
computadora('HP',     	'Prodesk 400',       	'Escritorio', 'Multimedia', '1,500,000', '29"',  			'AMD A8',               'AMD Radeon R7',           	'8GB',  'Windows 8.1', '500GB',  '6', '2', 'hp_prodesk_400')	:- hp_prodesk_400, !.
computadora('Acer', 	'Vx2631g', 		 		'Escritorio', 'Multimedia', '1,600,000', '17"', 			'Intel Core i3', 		'Intel H81 Express', 		'4GB',	'Windows 7', 	'500GB', '4', '2', 'acer_vx2631g')		:- acer_vx2631g, !.
computadora('Lenovo', 	'M53p', 		 		'Escritorio', 'Disenio', 	'1,200,000', '22"', 			'Intel Celeron', 		'Integrados Intel',			'8GB',	'Windows 7', 	'1TB', 	 '2', '6', 'lenovo_m53p')		:- lenovo_m53p, !.
computadora('Apple', 	'iMac', 		 		'Escritorio', 'Disenio', 	'4800,000', '27" Retina 5K', 	'Intel Core i5', 		'AMD Radeon R9 M395.', 		'16GB', 'OS X',			'2TB', 	 '0', '4', 'imac')				:- imac, !.
computadora('GHIA', 	'Ci7 4790', 	 		'Escritorio', 'Gamer', 	  	'1,200,200', '24"', 			'Intel Core i7', 		'Intel HD 4600', 			'8GB', 	'Windows 8.1', 	'1TB',	 '2', '8', 'ghia_ci7_4790')		:- ghia_ci7_4790, !.
computadora('HP', 		'Elite one 800', 		'Escritorio', 'Gamer', 	  	'2,400,000', '23" (Tactil)',	'Intel Core i7', 		'Intel HD 4600', 			'8GB', 	'Windows 8.1', 	'1TB', 	 '4', '4', 'hp_elite_one800')	:- hp_elite_one800, !.
...
%%%%%%%%%%%%%%%%%%%%Escritorio
 dell_inspiron_3046:- 
             ...
             muchoAlmacenamiento,
             monitorP,
             verifica('debe costar menos de 1,000,000'),
...
imac:- 			
 			  osx,
				...
				verifica('puede costar mas de 4,000,000').
...
costoM:- 				verifica('debe costar entre 2,000,000 y 3,000,000').
economico:- 			verifica('debe ser un equipo economico (1,000,000 o menos)').
...
muyCara:-				verifica('costaria mas de 3,000,000 millones pesos').
...
precioMedio:-			verifica('debe costar entre 2,000,000 y 3,000,000').
